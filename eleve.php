...
<body style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100vh; margin: 0;">
    ...
    <h2 style="margin: 0; position: absolute; top: 140px; font-size: 34px; color: #333; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.1);">Bienvenue Eleve</h2>
    <div style="display: flex; justify-content: center; gap: 40px; margin-top: 20px;">  
        <button onclick="window.location.href='Eleve/ajoutCR.php'">Ajout</button>
        <button onclick="window.location.href='Eleve/modifCR.php'">Modification</button>
        <button onclick="window.location.href='Eleve/createStage.php'">Créer un Stage</button>
    </div>
